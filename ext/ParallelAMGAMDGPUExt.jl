...
"""
function ParallelAMG.csr_from_gpu(A::ROCSparseMatrixCSR{Tv, Ti}) where {Tv, Ti}
    rp = A.rowPtr
    cv = A.colVal
    nzv = A.nzVal
...
"""
function ParallelAMG.amg_setup(A::ROCSparseMatrixCSR{Tv, Ti},
...
AMG resetup accepting an AMDGPU sparse CSR matrix. Uses backend and block_size
from the hierarchy.
"""
